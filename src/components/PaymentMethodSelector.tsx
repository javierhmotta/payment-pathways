...
import { CreditCard, Wallet, Bitcoin, Zap, Coins, Check, Landmark, Building2, Plus } from "lucide-react";
...
const paymentMethods: PaymentMethod[] = [
  ...
  },
  {
    ...
    type: "manual",
    discount: 5,
    tooltip: "The Lightning Network (LN) is a payment protocol built on the bitcoin blockchain"
  },
  {
    id: "usdt",
    name: "USDT",
...
export function PaymentMethodSelector({
  ...
  const isCreditCardSelected = selectedMethod === "credit_card";
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              <Badge
                variant={isManualSelected ? "default" : "secondary"}
                className={isManualSelected ? "bg-emerald-600 hover:bg-emerald-600" : ""}
              >
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              <Badge
                variant={isRecurringSelected ? "default" : "secondary"}
                className={isRecurringSelected ? "bg-emerald-600 hover:bg-emerald-600" : ""}
              >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {method.discount && (
            <Badge
              variant="outline"
              className="bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-300 border-amber-300 dark:border-amber-700 text-xs"
            >
              {method.discount}% off
            </Badge>
          )}
